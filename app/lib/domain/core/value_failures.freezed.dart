...
class _$ValueFailureTearOff {
  ...
  ExceedingLength<T> exceedingLength<T>(
      {required String incorrectValue, required int max}) {
...
mixin _$ValueFailure<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String incorrectValue, int max) exceedingLength,
  }) =>
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(String incorrectValue, int max)? exceedingLength,
...
abstract class $ExceedingLengthCopyWith<T, $Res>
  ...
  @override
  $Res call({String incorrectValue, int max});
}
...
class _$ExceedingLength<T> implements ExceedingLength<T> {
  const _$ExceedingLength({required this.incorrectValue, required this.max});
  ...
  @override
  String toString() {
    return 'ValueFailure<$T>.exceedingLength(incorrectValue: $incorrectValue, max: $max)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return exceedingLength(incorrectValue, max);
  }
